...
final class Brille24SyliusOrderLogExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    ...
    private function prependDoctrineMapping(ContainerBuilder $container): void
    {
        ...
        $container->prependExtensionConfig('doctrine', [
            'orm' => [
                'mappings' => [
                    'Brille24SyliusOrderLogPlugin' => [
                        'type' => 'xml',
                        'dir' => $this->getPath($container, '/config/doctrine/'),
                        'is_bundle' => false,
                        'prefix' => 'Brille24\SyliusOrderLogPlugin\Entity',
                        'alias' => 'Brille24SyliusOrderLogPlugin',
                    ],
                ],
            ],
        ]);
    ...
    private function getPath(ContainerBuilder $container, string $path): string
    {
        ...
        return $metadata['Brille24SyliusOrderLogPlugin']['path'] . $path;
    }
}
