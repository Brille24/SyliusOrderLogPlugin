...
class Brille24AdminOrderLogEntry extends AbstractGrid
{
    public static function getName() : string
    {
        return 'brille24_admin_order_log_entry';
    }
    public function buildGrid(GridBuilderInterface $gridBuilder) : void
    {
        $gridBuilder
            ...
            ->setDriverOption('class', '%brille24.model.order_log_entry.class%')
            ->setLimits([
                100,
            ])
            ->addField(
    ...
    {
        return '%brille24.model.order_log_entry.class%';
    }
}
