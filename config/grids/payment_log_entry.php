...
class Brille24AdminPaymentLogEntry extends AbstractGrid
{
    ...
    public function buildGrid(GridBuilderInterface $gridBuilder) : void
    {
        $gridBuilder
            ...
            ->setDriverOption('class', '%brille24.model.payment_log_entry.class%')
            ->setLimits([
                100,
            ])
            ->addField(
    ...
    {
        return '%brille24.model.payment_log_entry.class%';
    }
}
